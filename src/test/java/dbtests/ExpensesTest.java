...
import uitests.CreditReportTest;
...
public class ExpensesTest extends TestBase {
    ...
    public void RentalExpenses ( ) throws SQLException {
        ...
        loginPage.usernameField.sendKeys ( ConfigReader.getProperty ( "username5" ) );
        loginPage.passwordField.sendKeys ( ConfigReader.getProperty ( "password5" ) );
    ...
    @Test
    public void MortageExpenses ( ) throws SQLException {
        /*--- creating connection*/
        DataBaseUtility.createConnection ( );
        ...
        /*--- short cut to the "Expenses" page*/
        LoginPage loginPage = new LoginPage();
        do {loginPage.login(ConfigReader.getProperty("username5"),
                ConfigReader.getProperty("password5"));}
